...
export default function TulPerdePage() {
    ...
    const allImages = [
        '/services/tul-perde/tul1.jpg',
        '/services/tul-perde/tul2.jpg',
        '/services/tul-perde/tul3.jpg',
        '/services/tul-perde/tul4.jpg',
        '/services/tul-perde/tul5.jpg',
        '/services/tul-perde/tul6.jpg',
        '/services/tul-perde/tul7.jpg',
        '/services/tul-perde/tul8.jpg',
        '/services/tul-perde/tul9.jpg',
        '/services/tul-perde/tul10.jpg',
        '/services/tul-perde/tul11.jpg',
        '/services/tul-perde/tul12.jpg',
        '/services/tul-perde/tul13.jpg',
        '/services/tul-perde/tul14.jpg',
        '/services/tul-perde/tul15.jpg',
        '/services/tul-perde/tul16.jpg',
        '/services/tul-perde/tul17.jpg',
        '/services/tul-perde/tul18.jpg',
        '/services/tul-perde/tul19.jpg',
        '/services/tul-perde/tul20.jpg',
    ];
        ...
        <div className="service-page">
            ...
            <section className="service-hero">
                <div className="service-hero-content">
                    <h2>Tül Perde Koleksiyonumuz</h2>
