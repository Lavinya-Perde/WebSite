...
export default function DuvarKagidiPage() {
    ...
    const allImages = [
        '/services/duvar-kagidi/duvar1.jpg',
        '/services/duvar-kagidi/duvar2.jpg',
        '/services/duvar-kagidi/duvar3.jpg',
        '/services/duvar-kagidi/duvar4.jpg',
        '/services/duvar-kagidi/duvar5.jpg',
        '/services/duvar-kagidi/duvar6.jpg',
        '/services/duvar-kagidi/duvar7.jpg',
        '/services/duvar-kagidi/duvar8.jpg',
        '/services/duvar-kagidi/duvar9.jpg',
        '/services/duvar-kagidi/duvar10.jpg',
        '/services/duvar-kagidi/duvar11.jpg',
        '/services/duvar-kagidi/duvar12.jpg',
        '/services/duvar-kagidi/duvar13.jpg',
        '/services/duvar-kagidi/duvar14.jpg',
        '/services/duvar-kagidi/duvar15.jpg',
        '/services/duvar-kagidi/duvar16.jpg',
        '/services/duvar-kagidi/duvar17.jpg',
        '/services/duvar-kagidi/duvar18.jpg',
        '/services/duvar-kagidi/duvar19.jpg',
        '/services/duvar-kagidi/duvar20.jpg',
    ];
        ...
        <div className="service-page">
            ...
            <section className="service-hero">
                <div className="service-hero-content">
                    <h2>Duvar Kağıdı Koleksiyonumuz</h2>
