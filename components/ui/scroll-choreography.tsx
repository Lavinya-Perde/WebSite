...
export function ScrollChoreography({
    ...
    const baseImageClasses =
        "absolute left-1/2 top-1/2 w-[36vw] h-[24vh] overflow-hidden -translate-x-1/2 -translate-y-1/2 bg-[var(--paper-card)] shadow-2xl will-change-transform";
        ...
        <div ref={containerRef} className={cn("relative h-[300vh] w-full", className)}>
            <div className="sticky top-0 h-screen w-full overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center">
                    ...
                    >
                        <Image src={images.topLeft} alt="Top Left" fill sizes="36vw" className="object-cover" />
                    </motion.div>
                    ...
                    >
                        <Image src={images.bottomRight} alt="Bottom Right" fill sizes="36vw" className="object-cover" />
                    </motion.div>
                    ...
                    >
                        <Image src={images.bottomLeft} alt="Bottom Left" fill sizes="36vw" className="object-cover" />
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        className={cn(baseImageClasses, "z-40 origin-center bg-[var(--paper-deep)]")}
                    >
                        <Image src={images.topRight} alt="Top Right (Hero)" fill sizes="100vw" className="object-cover" />
                    </motion.div>
                </div>
            </div>
        </div>
